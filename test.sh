...
# case $car in 
#     "Testla")
#         echo -n "You are a man using ${car} in United States"
#         ;;
#     "Toyota" | "honda" | "Nissan")
#         echo -n "You follow  middle class people using ${car} in United States"
#         ;;
#     "Mercedes" | "BMW" | "Audi")
#         echo -n "You arrive using ${car} in United States"
#         ;;
#     *)
#         echo -n "You follow for popular cars  using ${car} in United States"
#         ;;
# esac
​
#Bash Loops
